...
MEDICATION_TYPE_VALUE__WEBSTERCARE = ugettext_noop("Webstercare")
MEDICATION_TYPE_VALUES = [MEDICATION_TYPE_VALUE__PRN, MEDICATION_TYPE_VALUE__REGULAR, MEDICATION_TYPE_VALUE__WEBSTERCARE]
...
DEFAULT_MEDICATION_REMINDER_TITLE = "TCC Cardiac - Medication Reminder"
